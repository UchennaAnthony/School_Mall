...
namespace SchoolMall.Data
{
    public class Repository : IRepository, IDisposable
    {
        private bool disposed = false;
        protected School_MallEntities context;

        public Repository() : this(new School_MallEntities()) { }

        public Repository(School_MallEntities _context)
        {
            context = _context;
        }
